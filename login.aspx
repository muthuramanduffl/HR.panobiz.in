<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="loginboth" %>
    <!DOCTYPE html>
    <html lang="en">
            ...
            <form id="form1" runat="server">
                ...
                <div class="register">
                    ...
                    <div class="col-lg-12 login-form px-0 px-sm-3" id="div_login" runat="server">
                        ...
                        <div class="form-group pt-0 col-8 px-0 ml-auto text-right">
                            <%-- <input type="button" class="resend-otp reset-mpin mx-0 w-100 px-0 text-right"
                                value="Forgot MPIN ? Reset MPIN">--%>
                                <asp:Button ID="Button1" runat="server" CssClass="resend-otp mx-0 w-100 px-0 text-right"
                        ...
                        <h4>To Register, <a href="register.aspx">Click Here</a> </h4>
                    ...
                    <div id="div_otp" runat="server">
                        <h4 class="login-tit">
                            ...
                            <%-- <input type="text" value="xxxxxxx647" class="font-weight-bold border-0"
                                style="width: 93px;" readonly>--%>
                                <asp:TextBox ID="txtmobile" CssClass="font-weight-bold border-0" runat="server"
                                    Style="width: 115px;" ReadOnly="true"></asp:TextBox>
                        </h4>
                        <div class="form-group col-lg-5 col-6 pb-0 mx-auto">
                            <div class="floating-label">
                        ...
                        <div class="form-group">
                            <%-- <input type="button" class="btn btn-dark otp-submit" value="Submit">--%>
                                <asp:Button ID="btnchkOTP" runat="server"
                                    CssClass="btn btn-dark otp-submit otpSubmit-btn" Text="Submit"
                                    OnClick="btnchkOTP_Click" ValidationGroup="OTPval" />
                        </div>
                        <div class="text-center" style="font-size: 12px;">
