...
/// </summary>
public class demoEmailandwhatsapp5
{
  public  string EMPID { get; set; }

    
	public demoEmailandwhatsapp5()
	{
		//
    ...
    public void SendWhatsAppMessage(string strname, string strempid1, string strphoneno, string strlocation, string stwhatsappno)
    {
        ...
        using (var client = new HttpClient())
        {
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://live-mt-server.wati.io/300729/api/v1/sendTemplateMessage?whatsappNumber=" + stwhatsappno + ""),
                Headers =
        {
...
#region SendSupAddEmpWhatsAppMessage
    ...
    public int SelectapprovalONLYUpdate(demoEmailandwhatsapp5 update)
    {
    ...
    public void UpdateapprovalALL()
    {
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("spapprovalAll", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                rowsAffected = command.ExecuteNonQuery();
