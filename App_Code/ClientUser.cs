...
public class ClientUser
{
    ...
    public DataSet ViewValidClientLogin(string stUserName, string stPassword)
    {
        string connetionString = null;
        SqlConnection cnn;
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("ViewValidClientLogin", cnn))
            {
                cnn.Open();
    ...
    public int AddUserLogin(ClientUser user)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public int UpdateUserLogin(ClientUser user)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
    ...
    public string GetCompanyID()
    {
        ...
        try
        {
            HttpCookie LoginCompanyCookie = HttpContext.Current.Request.Cookies["AdminCompanyName"];
            if (LoginCompanyCookie != null)
            {
                if (!string.IsNullOrEmpty(LoginCompanyCookie.Value) && LoginCompanyCookie.Value.Contains("AdminCompanyName="))
                {
                    strEmpId = LoginCompanyCookie.Value.Replace("AdminCompanyName=", "");
                }
                else
                {
        ...
        // try
        // {
        //     if (HttpContext.Current.Session["AdminCompanyName"] != null)
        //     {
        //         strEmpId = Convert.ToString(HttpContext.Current.Session["AdminCompanyName"]);
        //     }
        //     if (string.IsNullOrEmpty(strEmpId))
        //     {
        //         if (HttpContext.Current.Request.Cookies["AdminCompanyName"] != null)
        //         {
        //             System.Web.HttpCookie Logincookie = HttpContext.Current.Request.Cookies["AdminCompanyName"];
        //             strEmpId = Logincookie["AdminCompanyName"];
        //         }
        //     }
        // }
        // catch
